...
function resolveTestCommand(file: string, override?: string): string {
  ...
  if (normalized.endsWith("/src/core/schema/service.ts")) {
    return "bun --env-file=.env test src/test/schema-service.test.ts src/test/schema-service-private-coverage.test.ts src/test/cli/cli-contract.test.ts src/test/types/composite-type-evolution.test.ts src/test/types/domain-range-lifecycle.test.ts";
  }
  ...
  if (normalized.endsWith("/src/core/schema/handlers/sql-object-handler.ts")) {
    return "bun --env-file=.env test src/test/sql-object-handler.test.ts src/test/schema-service-private-coverage.test.ts src/test/types/domain-range-lifecycle.test.ts";
  }
