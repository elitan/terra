...
- done: reject explicitly schema-qualified user-defined operators in PostgreSQL virtual generated expressions during planning, including their indirect user-defined function dependency, while permitting explicitly qualified `pg_catalog` operators.
